    ...
    <div class="workspace" style="flex:1;overflow:hidden">
      ...
      <div class="main-content">
        <div class="toolbar">
          ...
          ${project.hasRom ? `<a class="btn btn-sm" id="btn-open-damos-dl" href="/api/projects/${projectId}/open-damos.a2l" download="open_damos_${project.ecu || 'ecu'}_${project.name?.replace(/[^a-z0-9]/gi, '_').toLowerCase() || 'project'}.a2l" title="Télécharger l'open_damos relocalisé pour cette ROM (A2L ASAP2 standard, utilisable dans WinOLS / TunerPro)">🧬 open_damos</a>` : ''}
